...
_GLYPHS = {
    ...
    # -- Lowercase ---------------------------------------------------------
    'r': (4.0,
          [[(0, 0), (1.8, 0), (1.8, 5.2), (4.0, 5.2),
            (4.0, 7), (0, 7)]],
          []),

    # Inter Bold single-story 'a': L-shaped bowl with right stem to x-height.
    # Bowl top at y=5.6 (~80% of x-height), step to y=7 is subtle (1.4 units).
    # Larger counter hole for better visibility at deboss scale.
    'a': (5.4,
          [[(0, 0), (5.4, 0), (5.4, 7), (3.6, 7),
            (3.6, 5.6), (0, 5.6)]],
          [[(1.8, 1.6), (3.6, 1.6), (3.6, 4.0), (1.8, 4.0)]]),
    ...
    # Inter-style 'l': plain vertical stroke (distinguished from 'i' by height + no dot).
    'l': (1.8,
    ...
    # Proper 'e': enclosed upper counter + lower-right mouth opening.
    # Bottom bar (full width) -> left wall through mouth -> crossbar+top (full width).
    # Hole cuts the upper counter between crossbar and top bar.
    'e': (5.4,
          [[(0, 0), (5.4, 0), (5.4, 1.8), (1.8, 1.8),
            (1.8, 3.2), (5.4, 3.2), (5.4, 7), (0, 7)]],
          [[(1.8, 4.2), (3.6, 4.2), (3.6, 5.2), (1.8, 5.2)]]),
    ...
    # Inter-style 't': stem centered, crossbar even on both sides (1.2 each).
    't': (4.2,
          [[(1.2, 0), (3.0, 0), (3.0, 5.2), (4.2, 5.2),
            (4.2, 7), (3.0, 7), (3.0, 10), (1.2, 10),
            (1.2, 7), (0, 7), (0, 5.2), (1.2, 5.2)]],
          []),
}
